...
parser.add_argument('--cv_dir', default='checkpoints_slimmable/teachers/cifar10/r50_32B/11_29/all4width_batchsize100', help='checkpoint directory (models and logs are saved here)')
