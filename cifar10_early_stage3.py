...
parser.add_argument('--deviceid', type=list, default=[4], help='')

parser.add_argument('--cv_dir', default='checkpoints_early/distill/cifar10/r50_48B/12_23/batchsize30_no_branch', help='checkpoint directory (models and logs are saved here)')
parser.add_argument('--binary_bits', type=int, default=48, help='length of hashing binary')
# parser.add_argument('--margin', type=float, default=6, help='margin of triplet loss')
...
parser.add_argument('--samples_each_label', type=int, default=3, help='number of samples each label in a batch')
...
def Load_checkpoint():
    ...
    target_checkpoint = torch.load(
        # 'checkpoints_slimmable/teachers/cifar10/r50_48B/11_23/margin_20_lr_1e-4_lrstep_150/mAP_-1.00000_-1.00000_-1.00000_0.87871_E_40.pth',
        # 'checkpoints_slimmable/teachers/cifar10/r50_48B/11_26/only1x/E_150_mAP_-1.00000_-1.00000_-1.00000_0.89117.pth',
        'checkpoints_slimmable/teachers/cifar10/r50_48B/11_26/all4width/E_130_mAP_-1.00000_-1.00000_-1.00000_0.90601.pth',
        # 'checkpoints_slimmable/teachers/cifar10/r50_12B/11_28/all4width_batchsize100/E_140_mAP_-1.00000_-1.00000_-1.00000_0.87841.pth',
        # 'checkpoints_slimmable/teachers/cifar10/r50_24B/11_28/all4width_batchsize100/E_150_mAP_-1.00000_-1.00000_-1.00000_0.89512.pth',
        # 'checkpoints_slimmable/teachers/cifar10/r50_32B/11_29/all4width_batchsize100/E_130_mAP_-1.00000_-1.00000_-1.00000_0.90140.pth',
        # '/data1/azzh/PycharmProject/resnetKD0/checkpoints_early/teachers/cifar10/r50_48B/12_05/default/E_110_mAP_-1.00000_-1.00000_-1.00000_0.90561.pth',
        map_location='cpu')
