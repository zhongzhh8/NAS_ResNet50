...
parser.add_argument('--cv_dir', default='cv/checkpoint3/11_18/try/', help='checkpoint directory (models and logs are saved here)')
parser.add_argument('--margin', type=float, default=20, help='margin of triplet loss')

parser.add_argument('--batch_size', type=int, default=256, help='batch size')
parser.add_argument('--epoch_step', type=int, default=150, help='epochs after which lr is decayed')
...
class OnlineTripletLoss_cross_triplet(nn.Module):
    ...
    def forward(self, code1, code2, code3, code4, code_target, target):
        ...
        losses += F.relu(ap_distances - an_distances + 20).mean()
...
# # b1_checkpoint = '../../../disk2/zenghaien/ckt/pretrained/cifar10/R18_48B/ckpt_E_200_mAP_0.73024_0.79022_0.82236_0.85335_branchFirst.t7'
# b1_checkpoint = 'pretrained/cifar10/R18_48B/ckpt_E_200_mAP_0.73024_0.79022_0.82236_0.85335_branchFirst.t7'
# b1_checkpoint = torch.load(b1_checkpoint)
# BranchFirst.load_state_dict(b1_checkpoint)
#
# # b2_checkpoint = '../../../disk2/zenghaien/ckt/pretrained/cifar10/R18_48B/ckpt_E_200_mAP_0.73024_0.79022_0.82236_0.85335_branchSecond.t7'
# b2_checkpoint = 'pretrained/cifar10/R18_48B/ckpt_E_200_mAP_0.73024_0.79022_0.82236_0.85335_branchSecond.t7'
# b2_checkpoint = torch.load(b2_checkpoint)
# BranchSecond.load_state_dict(b2_checkpoint)
#
# # b3_checkpoint = '../../../disk2/zenghaien/ckt/pretrained/cifar10/R18_48B/ckpt_E_200_mAP_0.73024_0.79022_0.82236_0.85335_branchThird.t7'
# b3_checkpoint = 'pretrained/cifar10/R18_48B/ckpt_E_200_mAP_0.73024_0.79022_0.82236_0.85335_branchThird.t7'
