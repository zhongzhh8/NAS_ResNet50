...
parser.add_argument('--deviceid', type=list, default=[7], help='')

parser.add_argument('--cv_dir', default='checkpoints_slimmable/distill/sun42/r50_48B/12_26/no_load_branches', help='checkpoint directory (models and logs are saved here)')
