...
parser.add_argument('--deviceid', type=list, default=[1], help='')

parser.add_argument('--cv_dir', default='checkpoints_slimmable/distill/cifar10/r50_32B/11_29/default', help='checkpoint directory (models and logs are saved here)')
...
parser.add_argument('--lr_step', type=int, default=100, help='epochs after which lr is decayed')
...
parser.add_argument('--samples_each_label', type=int, default=8, help='number of samples each label in a batch')
