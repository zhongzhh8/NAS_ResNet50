...
parser.add_argument('--cv_dir', default='checkpoints_slimmable_PNT/distill/cifar10/r50_32B/12_25/scratch2', help='checkpoint directory (models and logs are saved here)')
